...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<List<ErrorModel>> handleBusinessException(BusinessException bex){
        for(ErrorModel em: bex.getErrors()) {
            logger.info("business exception is thrown info: {} - {}",em.getCode(), em.getMessage());
            logger.warn("business exception is thrown warn: {} - {}",em.getCode(), em.getMessage());
            logger.debug("business exception is thrown debug: {} - {}", em.getCode(), em.getMessage());
            logger.error("business exception is thrown error: {} - {}", em.getCode(), em.getMessage());
        }
